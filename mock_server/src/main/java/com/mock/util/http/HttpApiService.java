...
public class HttpApiService {
	 ...
	 * @throws Exception
	 */
	public String doGet(String url, Map<String, Object> map, Map<String, String> headers) throws Exception {
	 ...
	 * @throws Exception
	 */
	public HttpResult doPost(String url, Map<String, Object> map, Map<String, String> headers) throws Exception {
		// 声明httpPost请求
